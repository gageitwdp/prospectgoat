                    ...
                    <form class="mt-6 space-y-4" @submit.prevent="parseCsv">
                        <div>
                            ...
                            <p class="mt-2 text-xs lp-muted">
                                Primary support: Mailing Labels (8) export format. Other CSV formats are automatically analyzed and mapped where possible, and unmapped fields are left blank for review.
                            </p>
                        </div>
