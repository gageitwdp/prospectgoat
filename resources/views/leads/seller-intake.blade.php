...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @php
            $shareTitle = 'Seller Intake - ' . config('app.name', 'ProspectGoat');
            $shareDescription = 'Complete the seller intake form with ProspectGoat.';
        @endphp

        @include('partials.share-meta')

        <title>Seller Intake - {{ config('app.name', 'ProspectGoat') }}</title>
